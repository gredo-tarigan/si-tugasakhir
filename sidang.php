                ...
                <div class="container-fluid" style="padding: 0px;padding-top: 35px;padding-right: 100px;padding-left: 100px;">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h2 class="text-center" style="padding-bottom: 0px;">Jadwal Sidang</h2>
                        </div>
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><strong>Dosen Penguji 1 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:</strong><strong style="padding-left: 25px;"><?php echo $row["dosen_penguji3"];?></strong></li>
                            <li class="list-group-item"><strong>Dosen Penguji 2 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:</strong><strong style="padding-left: 25px;"><?php echo $row["dosen_penguji4"];?></strong></li>
                            <li class="list-group-item"><strong>Tanggal Seminar &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:</strong><strong style="padding-left: 25px;"><?php echo $row["jadwal2"];?></strong></li>
                        </ul>
                    </div>
