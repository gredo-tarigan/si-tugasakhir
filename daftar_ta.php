        ...
        <div class="container-fluid" style="padding: 0px;padding-top: 35px;padding-right: 100px;padding-left: 100px;">
          <form action="daftarta.php" method="post">
            ...
            <div class="form-group">
              <select class="form-control" name="nik" style="width=200px" <?php if(!empty($row["nik"])) {echo "disabled";} ?>>
                <option value="" disabled selected><?php if(!empty($row["nik"])) { echo $row1["nama"]; } else {echo "Nama Dosen";}?></option>
              ...
              <br>
              <input type="submit" class="btn btn-primary btn-sm d-none d-sm-inline-block" type="submit" value="Daftar" name="Cari2" style="margin-left: 726px;width: 86px;" <?php if(!empty($row["nik"]) && !empty($row["judulta"])) {echo "disabled";} ?>>
            </form>
          </div>
        </div>
      </div>
