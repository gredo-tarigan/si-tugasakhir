        ...
        <div class="container-fluid" style="padding: 0px;padding-top: 35px;padding-right: 100px;padding-left: 100px;">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h2 class="text-center" style="padding-bottom: 0px;">Download Berkas</h2>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                <div class="row align-items-center no-gutters">
                  <div class="col mr-2">
                    <h6 class="mb-0" style="padding-bottom: 10px;"><strong>Form Pendaftaran Tugas Akhir</strong></h6>
                  </div>
                  <div><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="files/FormTA.pdf" download><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Download</a></div>
                </div>
              </li>
              <li class="list-group-item">
                <div class="row align-items-center no-gutters">
                  <div class="col mr-2">
                    <h6 class="mb-0" style="padding-bottom: 10px;"><strong>Form Pendaftaran Seminar Proyek</strong></h6>
                  </div>
                  <div><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="files/FormSemPro.pdf" download><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Download</a></div>
                </div>
              </li>
              <li class="list-group-item">
                <div class="row align-items-center no-gutters">
                  <div class="col mr-2">
                    <h6 class="mb-0" style="padding-bottom: 10px;"><strong>Form Pendaftaran Seminar Sidang</strong></h6>
                  </div>
                  <div><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="files/FormSemSi.pdf" download><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Download</a></div>
                </div>
              </li>
            </ul>
          </div>
