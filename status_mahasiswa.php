          ...
          <div class="container-fluid" style="padding: 0px;padding-top: 35px;padding-right: 40px;padding-left: 40px;">
            <div class="card shadow mb-4" style="width: 865px;">
              <div class="card-header py-3">
                <h2 class="text-center" style="padding-bottom: 0px;">Status Mahasiswa</h2>
              </div>
                  ...
                  <div class="row align-items-center no-gutters">
                    <div>
                      <div class="form-group">
                        <div style="padding-left: 10px;padding-right: 10px;">
                          <h6 class="mb-0" style="padding-bottom: 10px;"><strong>NIM Mahasiswa &nbsp; &nbsp; :</strong></h6><form action="status_mahasiswa.php" method="get"><input placeholder="ex : 2107011714xxxx" name="cari2" type="number" style="width: 802px;"></div>
                          </div>
                        </div>
                      </div>
                    ...
                    <li class="list-group-item">
                      <form enctype="multipart/form-data" method="POST" action="upload_file3.php">
                        ...
                        <div class="form-group"><strong>Status Mahasiswa</strong><strong style="padding-left: 30px;">:</strong>
                          <select id='status' class="form-control" name="status">
                            <option value="" disabled selected>Status Mahasiswa</option>
                            <option value="Sudah Mendaftar Tugas Akhir">Sudah Mendaftar Tugas Akhir</option>
                            <option value="Revisi Tugas Akhir">Revisi Tugas Akhir</option>
                            <option value="Revisi Seminar Proposal">Revisi Seminar Proposal</option>
                            <option value="Lulus Seminar Proposal">Lulus Seminar Proposal</option>
                            <option value="Lulus Sidang Tugas Akhir">Lulus Sidang Tugas Akhir</option>
                            <option value="Mahasiswa Sudah Lulus">Mahasiswa Sudah Lulus</option>
                          </select>
                        </div>
