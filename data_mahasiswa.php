          ...
          <div class="container-fluid" style="padding: 0px;padding-top: 35px;padding-right: 40px;padding-left: 40px;">
            <div class="card shadow mb-4" style="width: 865px;">
              <div class="card-header py-3">
                <h2 class="text-center" style="padding-bottom: 0px;">Data Mahasiswa</h2>
              </div>
                    ...
                    <div>
                      <div class="form-group">
                        <div style="padding-left: 10px;padding-right: 10px;">
                          <h6 class="mb-0" style="padding-bottom: 10px;"><strong>NIM Mahasiswa &nbsp; &nbsp; :</strong></h6><form action="data_mahasiswa.php" method="get"><input placeholder="ex : 2107011714xxxx" name="cari2" type="number" style="width: 802px;"></div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="form-group"><strong>Dosen Penguji 1</strong><strong style="padding-left: 167px;padding-right: 23px;">:</strong>
              <select id='dosen_penguji1' class="form-control" name="dosen_penguji1">
            ...
            <div class="form-group"><strong>Dosen Penguji 2</strong><strong style="padding-left: 167px;padding-right: 23px;">:</strong>
              <select id='dosen_penguji2' class="form-control" name="dosen_penguji2">
                <option value="" disabled selected></option>
                <option value="Dr.Ir.RM. Haryo Santoso , MM">Dr.Ir.RM. Haryo Santoso , MM</option>
                <option value="Ir. Heru Prastawa, DEA">Ir. Heru Prastawa, DEA</option>
                <option value="Dr. Aries Susanty, ST, MT">Dr. Aries Susanty, ST, MT</option>
            ...
            <div class="form-group"><strong>Dosen Penguji 1</strong><strong style="padding-left: 167px;padding-right: 23px;">:</strong>
              <select id='dosen_penguji3' class="form-control" name="dosen_penguji3">
                <option value="" disabled selected></option>
                <option value="Dr.Ir.RM. Haryo Santoso , MM">Dr.Ir.RM. Haryo Santoso , MM</option>
                <option value="Ir. Heru Prastawa, DEA">Ir. Heru Prastawa, DEA</option>
                <option value="Dr. Aries Susanty, ST, MT">Dr. Aries Susanty, ST, MT</option>
            ...
            <div class="form-group"><strong>Dosen Penguji 2</strong><strong style="padding-left: 167px;padding-right: 23px;">:</strong>
              <select id='dosen_penguji4' class="form-control" name="dosen_penguji4">
                <option value="" disabled selected></option>
                <option value="Dr.Ir.RM. Haryo Santoso , MM">Dr.Ir.RM. Haryo Santoso , MM</option>
                <option value="Ir. Heru Prastawa, DEA">Ir. Heru Prastawa, DEA</option>
                <option value="Dr. Aries Susanty, ST, MT">Dr. Aries Susanty, ST, MT</option>
